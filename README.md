# Kola-Aderoju-eduhub-2nd-semester-Examination
...
eduhub-project/
├── README.md
├── EduHub_Database.ipynb
├── SampleData/
│   ├── EduHub_Database.assignments.json
│   ├── EduHub_Database.courses.json
│   ├── EduHub_Database.enrollments.json
│   ├── EduHub_Database.lessons.json
│   ├── EduHub_Database.submissions.json
│   └── EduHub_Database.users.json
├── docs/
│   └── (EduHub-MongoDB-Powered-E-Learning-Platform.ppt)
└── requirements.txt
```
